...
INSERT INTO ROLE_LISTINGS VALUES
(123456,234567894,"Searching for a Fire Warden!",123456787,STR_TO_DATE('2023-09-20', '%Y-%m-%d'),STR_TO_DATE('2023-12-01', '%Y-%m-%d'),123456788,STR_TO_DATE('2023-09-20', '%Y-%m-%d'),123456788,STR_TO_DATE('2023-09-20', '%Y-%m-%d')),
(123457,234567891,"Looking for new head of Talent Attraction!",123456787,STR_TO_DATE('2023-09-20', '%Y-%m-%d'),STR_TO_DATE('2023-11-30', '%Y-%m-%d'),123456788,STR_TO_DATE('2023-09-20', '%Y-%m-%d'),123456788,STR_TO_DATE('2023-09-20', '%Y-%m-%d')),
(123458,234567892,"Looking for new Learning Facilitator",123456789,STR_TO_DATE('2023-09-20', '%Y-%m-%d'),STR_TO_DATE('2023-12-20', '%Y-%m-%d'),123456788,STR_TO_DATE('2023-09-20', '%Y-%m-%d'),123456788,STR_TO_DATE('2023-09-20', '%Y-%m-%d')),
(123459,234567893,"Need an Agile Coach",123456786,STR_TO_DATE('2023-09-20', '%Y-%m-%d'),STR_TO_DATE('2023-12-20', '%Y-%m-%d'),123456788,STR_TO_DATE('2023-09-20', '%Y-%m-%d'),123456788,STR_TO_DATE('2023-09-20', '%Y-%m-%d'));
...
INSERT INTO ROLE_APPLICATIONS VALUES
(512345, 123456, 123456789, 'withdrawn', STR_TO_DATE('2023-11-03', '%Y-%m-%d')),
(512346, 123457, 123456789, 'applied', STR_TO_DATE('2023-11-03', '%Y-%m-%d'));